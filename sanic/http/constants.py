fclass Stage(Enum):
    ...
    HANDLER = 2  # Headers done, handler running
    RESPONSE = 3  # Response headers sent, body in progress
    FAILED = 100  # Unrecoverable state (error while sending response)um, IntEnum
